    ...
    <div className="flex h-screen bg-white ">
      ...
      <div className=" sm:w-1/2 w-full flex flex-col min-h-screen bg-center bg-no-repeat bg-cover bg-[url('/images/bg.png')] sm:bg-none sm:justify-between justify-end items-center sm:mb-3 ">
        ...
        <div className="bg-white  p-3 sm:p-11.25 rounded-lg flex flex-col gap-6     ">
          ...
          <div>
            <p className="font-hanken font-bold text-[28px] -tractext-whiteking-[0.04] text-[#202020]">We’ve got your back.</p>
          ...
          <form method="post" className="flex flex-col gap-4">
            {SelectedEmail ? (
              <div className="gap-1 flex flex-col" >
                ...
                <input type="email" required name="email" placeholder="Entrez votre adresse email" className="border border-[#DDD] h-13.5 rounded-xl px-3 placeholder-[#505050] text-[#202020]" />
              </div>
            ) : (
              <div className="gap-1 flex flex-col" >
                <label htmlFor="phone" className="leading-none font-hanken text-base font-bold">Phone number</label>
                <input required type="tel" name="phone" placeholder="Enter your phone number" className="border border-[#DDD] h-13.5 rounded-xl px-3 placeholder-[#505050] text-[#202020]" />
              </div>
            )}
            ...
            <div className=" relative gap-1 flex flex-col" >
              ...
              <input required type={showPassword ? "password" : 'text'} name="password" placeholder="Entrez votre mot de passe" className="border border-[#DDD] h-13.5 rounded-xl px-3 pr-7  placeholder-[#505050] text-[#202020]" />
            ...
            <div className="flex justify-between">
              <div className="flex gap-2">
                <input required type="checkbox" className="border-[#DDD] font-hanken font-normal text-[14px]" />
            ...
            <button type="submit" onClick={handleClick} className="bg-[#A1E86F] mt-7 text-[#153F2A] font-bold text-lg p-3 rounded-xl cursor-pointer">Se connecter</button>
          </form>

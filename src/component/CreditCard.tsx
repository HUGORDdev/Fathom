...
const CreditCard = ({planMode}:CreditCardProps) => {
  return (
    <div className=" group  perspective-[1000px]   font-hanken relative h-100 w-full flex items-center justify-center ">
      {/* Carte 3 - La plus au fond (Vert clair) */}
      <div className=" absolute animate-reveal [animation-delay:500ms] z-10 rounded-2xl p-[1.5px] 
                bg-linear-to-br from-[#2E6A4E] to-[#0E2E1E] 
                shadow-lg box-border -rotate-25 -translate-y-20 mr-10">

        <div className="w-108 h-66 scale-[1.20] sm:scale-none rounded-2xl bg-[#4A724D] p-4 shadow-xl box-border">
      ...
      <div className="absolute z-20  animate-reveal [animation-delay:400ms] rounded-2xl p-[1.5px] 
                bg-linear-to-br from-[#2E6A4E] to-[#27774e] 
                shadow-2xl box-border -rotate-10 translate-y-5 ml-12">

        <div className="w-108 h-66 scale-[1.20] sm:scale-none  rounded-2xl bg-[#2D5A42] -translate-y-8 p-4 shadow-2xl box-border">
          <div className="flex items-center justify-end gap-2">
            <img src="./images/Vector.png" className="w-5 h-5" />
            <p className="font-bold text-[16px] text-white -tracking-[0.25] ">Fathom</p>
          </div>
      ...
      <div className=" absolute scale-[1.20] sm:scale-none  z-30 animate-reveal [animation-delay:300ms] rounded-2xl p-[1.5px] 
                bg-linear-to-br from-[#2E6A4E] to-[#0E2E1E] 
        ...
        <div className="w-108 h-66 rounded-2xl bg-[#153F2A] p-4 flex flex-col justify-between text-white box-border">
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm font-bold text-[#E9F1FC]">
              {planMode?'LIMITLESS CARD':'INFINITY card'}
            </span>
